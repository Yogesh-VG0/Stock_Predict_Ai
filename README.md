...
sequenceDiagram
    ...
    participant M as ML Backend
    participant D as Database
    
    U->>F: Request stock prediction
    F->>B: API call with ticker
    B->>M: Forward to ML API
    M->>D: Fetch historical data
    M->>D: Get sentiment data
    M->>M: Generate features
    M->>M: Run ensemble models
    M->>D: Store predictions
    M->>B: Return predictions + confidence
    B->>F: Formatted response
    F->>U: Display predictions + charts
    
    Note over M,D: ML Backend handles:<br/>- Data ingestion<br/>- Feature engineering<br/>- Model training<br/>- Predictions
    
    Note over B,F: Frontend handles:<br/>- User interface<br/>- Real-time updates<br/>- Data visualization<br/>- User interactions
```
...
- **📧 Email**: support@stockpredict-ai.com
- **💬 Discord**: [Join our community](https://discord.gg/stockpredict-ai)
- **📚 Documentation**: [Full docs](https://docs.stockpredict-ai.com)
- **🐛 Bug Reports**: [GitHub Issues](https://github.com/your-username/stockpredict-ai/issues)
