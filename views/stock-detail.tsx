      ...
      >
        <form onSubmit={handleSearch} className="flex gap-2 mb-4">
          ...
          <button
            ...
            className="bg-emerald-500 hover:bg-emerald-400 text-black font-semibold rounded-lg px-5 py-2.5 text-sm disabled:opacity-40 disabled:cursor-not-allowed transition-all shadow-sm shadow-emerald-500/20 hover:shadow-emerald-500/30"
          >
            Search
          </button>
        </form>
